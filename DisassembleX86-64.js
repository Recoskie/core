...
Mnemonics = [
  ...
  "???",
  "","","","","","","","","","","","","","","","",//*The Rex Prefix note the REX prefix can now disable in diffrent bit modes allowing these to be used.
...
//The opcode register encoding comes first regarless of which order the operands go in. Then the ModR/M comes next.
//Then Immidate is always last. An instruction does not have to combine all encoding, but used one, or two.
//------------------------------------------------------------------------------------------------------------------------
...
/*The main goal of this dissasembler is to make the most croprehencible dissasembler possible for X86.
Everything is in order and is explained in depth thoughout the code. To how each varible is used thoughout the code.
At the same time An fast powerfull X86 dissasembler.*/
