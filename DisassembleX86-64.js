...
function SortOperands(Operands)
{
  ...
  for ( var i = 0; i < Operands.length; i += 2 )
  {
    ...
    if( Operands[i] == 1 )
    {
      ...
      {
        out[0] = new SOperands( Operands[i], //Type
        Operands[i + 1], //Size
    ...
    else if( Operands[i] > 1 & Operands[i] < 7 )
    {
      ...
      {
        out[1] = new SOperands(Operands[i], //Type
        Operands[i + 1], //Size
        OpNum++ //Operand Iteration number for which operand it is
        );
      }
    ...
    else if( Operands[i] == 7 )
    {
      ...
      {
        out[2] = new SOperands(Operands[i], //Type
        Operands[i + 1], //Size
        OpNum++ //Operand Iteration number for which operand it is
        );
      }
    ...
    else if(Operands[i] > 7 & Operands[i] < 11)
    {
      ...
      {
        out[IMM] = new SOperands(Operands[i], //Type
        Operands[i + 1], //Size
        OpNum++ //Operand Iteration number for which operand it is
        );
    ...
    {
      out[Explicit] = new SOperands(Operands[i], //Type
      Operands[i + 1], //Size
      OpNum++ //Operand Iteration number for which operand it is
      );
