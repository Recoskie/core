...
const Operands = [
  ...
  ["","0A0E07080001"],"",
  [
    ["0A040648","0B300730","0B700770","0A06066C0170"],
    ["0A040648","0B300730","0B700770","0A06066C0110"],
    "",""
  ],
  [
    [
  ...
  [
    ["06A90A0A","","",""],
    ["06480A04","07300B30",["07700B700108","","07700B70"],["066C0A060148","","066C0A060140"]],
  ...
  [
    ...
    ["0A040649","0A040730",["0B7007380112","","0B700770011A"],"0A06065A0112"],
    "0B3807700112"
  ],
  ...
  ["",["","","",["0A061206066C0178","","0A061206066C0110"]],"",""],
  "",
  ["",["","","",["0A061206066C0158","","0A061206066C0110"]],"",""],
  "","",
  ...
  ["",["",["0B3013300730","","0B3013300730"],["0B7013700770011A","","0B70137007700112"],""],"",""],
  ["",["",["0B3013300730","","0B3013300730"],["0B7013700770011A","","0B70137007700112"],["0A061206066C0178","","0A061206066C0110"]],"",""],
  ...
  [["0A040648","","",""],["","",["0A06066C0119","","0A06066C0111"],["0A06066C0108","",""]],"",""],
  [["0A040648","","",""],["","","",["0A06066C0108","",""]],"",""],
  [["0A040648","","",""],["","",["0A06066C0119","","0A06066C0111"],["0A06066C0108","",""]],"",""],
  [["0A0406482E00","","",""],["","",["0A04120406440109","","0A04120406460101"],["0A06066C0108","",""]],"",""],
  [["0A040648","","",""],["","",["0A06066C0119","","0A06066C0111"],["0A06066C0178","",""]],"",""],
  [["0A040648","","",""],["","",["0A04120406440109","","0A04120406460101"],["0A06066C0178","",""]],"",""],
  "","",
  ...
  ["",["","0A05065A0C00","0B7007700C000110",""],"",""],
  ["",["",["0B30133007300C00","",""],"",""],"",""],
  ["",["","",["0B70137007700C000118","","0B70137007700C000110"],["0A061206066C0C000108","","0A061206066C0C00"]],"",""],
  ...
  ["",["0A0406480C00","0B30133007300C00","",""],"",""],
  ["",["0A0406480C00","0B30133007300C00","",""],"",""],
  [["0A0A06A90C00","","",""],"0B70137007700C0001080NAN","",""],
  "","","","",
  ...
  "",
  ["",["","",["0B70137007700C000118","","0B70137007700C000110"],""],"",""],
  ["",["","",["0B7007700C000119","","0B7007700C000111"],["0A06066C0C000178","","0A06066C0C000110"]],"",""],
  ...
  ["",["","",["0A04120406440C000109","","0A04120406460C000101"],""],"",""],
  ["",["","","",["0A06066C0C000178","","0A06066C0C000110"]],"",""],
  "",
  ["",["","",["0B70137007700C000119","","0B70137007700C000111"],""],"",""],
  ["",["","",["0A04120406440C000109","","0A04120406460C000101"],""],"",""],
  ...
  "","","","","","","","","","","","","","","","",
  "","","","","","","","","","",
  [["","","","0A06066C0C000170"],["","","",["0A06066C0C000178","",""]],"",["","","","0A06066C0C000110"]],
  [["","","","0A06066C0C000150"],["","","",["0A06066C0C000178","",""]],"",""],
  "","","","",
  "","","","","","","","","","","","","","","",
  ["",["0A0406480C00","0A0406480C00","",""],"",""],
  "","","","","","","","","","","","","","","","",
...
---------------------------------------------------------------------------------------------------------------------------
In EVEX Some instructions use SAE which suppresses all errors, but if an instruction uses {er} the 4 others are used by vector length.
In MVEX the rounding mode can be adjusted using the MVEX option bit's in register mode with MVEX.E set to round with, or without error suppression.
-------------------------------------------------------------------------------------------------------------------------*/

const RoundModes = [
  "", "", "", "", //Not used.
  ",{RN}", ",{RD}", ",{RU}", ",{RZ}", //MVEX Round mode without Error suppression.
  ",{RN-SAE}", ",{RD-SAE}", ",{RU-SAE}", ",{RZ-SAE}", //MVEX Round mode with Error suppression, or EVEX Round mode control {er}.
  ",{SAE}", ",{SAE}", ",{SAE}", ",{SAE}" //EVEX uses all round modes with error suppression {sae}.
 ];
...
function Decode_ModRM_SIB_Address( ModRM, BySize, Setting )
{
  ...
  else
  {
    ...
    if( Extension === 3 && EH_ZeroMerg )
    {
	  RoundMode = 4 + ConversionMode;
	}
	
	//EVEX round mode.
	
	if( Extension === 2 && ConversionMode === 1 && ( ( VectS & 3 ) > 0 ) )
	{
	  RoundMode = ( 4 + SizeAttrSelect ) | ( ( VectS & 2 ) << 2 );
	}
...
function DecodeOpcode()
{
  ...
  if(Name instanceof Array && Name.length == 3)
  {
    ...
    ( Extension === 3 && EH_ZeroMerg && Name[1] !== "" ) && ( EH_ZeroMerg = false, bits = 1 ); //MVEX uses element 1 if MVEX.E is set for instruction that change name. 
